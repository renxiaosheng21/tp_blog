<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\wamp64\www\personalBlog\public/../application/admin\view\links\list.htm";i:1528467933;s:74:"D:\wamp64\www\personalBlog\public/../application/admin\view\common\top.htm";i:1551691190;s:75:"D:\wamp64\www\personalBlog\public/../application/admin\view\common\left.htm";i:1550716580;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php if($value['desc'] != ''): ?>
                                        <?php echo $value['desc']; else: ?>
                                    暂无描述    
                                    <?php endif; ?>
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('links/edit',array('id'=>$value['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    ·
 
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('links/del',array('id'=>$value['id'])); ?>')" class="btn btn-danger btn-sm shiny">
