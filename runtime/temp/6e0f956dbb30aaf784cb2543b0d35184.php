<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\wamp64\www\personalBlog\public/../application/index\view\index\index.html";i:1550719552;s:78:"D:\wamp64\www\personalBlog\public/../application/index\view\common\header.html";i:1528467933;s:77:"D:\wamp64\www\personalBlog\public/../application/index\view\common\right.html";i:1528467933;s:78:"D:\wamp64\www\personalBlog\public/../application/index\view\common\footer.html";i:1550719287;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
		...
		<div class="xnews2">
			<div class="pic"><a target="_blank" href="<?php echo url('article/index',array('arid'=>$value['id'])); ?>"><img src="<?php if($value['pic'] != ''): ?>__IMG__<?php echo $value['pic']; else: ?>__PUBLIC__/images/error.png<?php endif; ?> " alt="<?php echo $value['title']; ?>"/></a>
			</div>
			<div class="dec">
				...
				<div class="time"><a href='z95926.html'><?php echo $value['keywords']; ?></a>  </div>
			</div>
		</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
