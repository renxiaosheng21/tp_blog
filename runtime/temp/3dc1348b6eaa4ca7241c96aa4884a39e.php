...
<div class="overall">
	...
	<div class="left">
		...
		<?php if(is_array($searchres) || $searchres instanceof \think\Collection || $searchres instanceof \think\Paginator): $i = 0; $__LIST__ = $searchres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
		<div class="xnews2">
			<div class="pic">
